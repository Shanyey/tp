        ...
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Address("Blk 30 Geylang Street 29, #06-40"), new BloodType("AB+"), new Appointment("Nurse"),
                    getTagSet("Newcomer"), getMedicalHistorySet("")),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new BloodType("AB+"),
                    new Appointment("Nurse"), getTagSet("Manager"), getMedicalHistorySet("")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new BloodType("AB+"), new Appointment("Nurse"),
                    getTagSet("Specialse in lobotomy"), getMedicalHistorySet("")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new BloodType("AB+"),
                    new Appointment("Nurse"), getTagSet("Speaks malay"), getMedicalHistorySet("")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), new BloodType("AB+"), new Appointment("Patient"),
                    getTagSet("Discharge after treatment"), getMedicalHistorySet("Diabetes")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"), new BloodType("AB+"), new Appointment("Patient"),
                    getTagSet("Fear of blood"), getMedicalHistorySet("Diabetes"))
        };
    }
